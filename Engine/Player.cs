...
namespace Engine
{
    public class Player : LivingCreature
    {
        ...
        public bool HasRequiredItemToEnterThisLocation(Locations location)
        {
            if (location.ItemsRequiredToEnter == null)
            {
            ...
            {
                if (ii.Details.ID == location.ItemsRequiredToEnter.ID)
                {
